...
{
    /// <remarks>
    /// See http://bloggablea.wordpress.com/2007/05/01/global-hotkeys-with-net/
    /// </remarks>
    public class HotKey : IMessageFilter
    {
        ...
        public HotKey(Keys key = Keys.None, bool shift = false, bool control = false, bool alt = false, bool windows = false)
        {
            // Assign properties
            this.Key = key;
            this.Shift = shift;
        ...
        public HotKey Clone()
        {
            ...
            return new HotKey(this.key, this.shift, this.control, this.alt, this.windows);
        }
        ...
        public bool Register(Control windowControl)
        {
            ...
            // Register the hotkey
            if (HotKey.RegisterHotKey(windowControl.Handle, this.id, modifiers, key) == 0)
            { 
        ...
        public override string ToString()
        {
            ...
            // Build key name
            string keyName = Enum.GetName(typeof(Keys), this.key);;
            switch (this.key)
            {
                case Keys.D0:
                case Keys.D1:
